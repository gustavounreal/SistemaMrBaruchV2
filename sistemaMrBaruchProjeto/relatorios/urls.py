...
urlpatterns = [
    # Painel Central agora é a rota principal
    path('', views.painel_central, name='painel_central'),
    path('painel-central/', views.painel_central, name='painel_central_alt'),  # Alias
    
    # Antigo painel desativado (redireciona para o central)
    # path('antigo/', views.painel_relatorios, name='painel_relatorios'),
    ...
    path('consultores/', views.relatorio_consultores, name='relatorio_consultores'),
    path('compliance/', views.relatorio_compliance, name='relatorio_compliance'),
